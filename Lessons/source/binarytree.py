...
class BinaryTreeNode(object):
    ...
    def height(self):
        ...
        O(n) we have to iterate over each branch to calculate height"""
        right_len = 0
        left_len = 0
...
class BinarySearchTree(object):
    ...
    def contains(self, item):
        ...
        Worst case running time: O(log n) if there is more than one item"""
    ...
    def insert(self, item):
        ...
        Best case running time: O(1) if there is only one item
        Worst case running time: O(1) we are only inserting one item at a known place"""
    ...
    def _find_node_recursive(self, item, node):
        ...
        Best case running time: O(1) - one item to go through
        Worst case running time: O(log n) more than one to recurse through"""
    ...
    def _find_parent_node_iterative(self, item):
        ...
        Best case running time: O(1) - if there is only one item to iterate over
        Worst case running time: O(n), if there is more than one item to iterate over"""
